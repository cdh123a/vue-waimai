<template>
    <div class="shop-header">
      ...
      <div class="shop-content" @click=" isShowContent1=true">
      ...
      <div class="shop-header-discounts" v-if="info.supports"
           @click="isShowContent2=true">
        <div class="discounts-left">
          <div class="activity activity-green">
          <span class="content-tag">
            <span class="mini-tag">{{info.supports[0].name}}</span>
          </span>
            <span class="activity-content emplise">{{info.supports[0].content}}</span>
          </div>
        </div>
      ...
      <div class="shop-brief-modal" v-show="isShowContent1">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="isShowContent1=false">
     ...
     <transition name="fade">
       <div class="activity-sheet" v-show="isShowContent2" v-if="info.supports">
         <div class="activity-sheet-content">
           ...
           <div class="activity-sheet-close" @click="isShowContent2=false">
             <span class="iconfont icon-close"></span>
           </div>
         </div>
  ...
  export default {
    data () {
      return {
        ...
        //将类名根据type= 0 1 2来一次将类名放入这个数组  使用时根据classArr[support.type]来取出优惠活动的类名
      }
    },
    mounted () {
...
<style type="text/stylus" lang="stylus" rel="stylesheet/stylus" scoped>
  /*scoped相当于 函数的局部作用域 这里面的样式只能当前组件能访问  其余的不能访问*/
